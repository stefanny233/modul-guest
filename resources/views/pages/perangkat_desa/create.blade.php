...
@section('content')
    ...
    <div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-4">
            <h1 class="display-3 animated slideInDown">Pendaftaran </h1>
    ...
    </div> <!-- Page Header End --> <!-- Tambah Perangkat Desa Start -->
    <div class="container-fluid donate py-5">
        <div class="container">
            <div class="row g-0">
                    ...
                    <div class="h-100 p-5">
                        ...
                        <form action="{{ route('perangkat_desa.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf <div class="row g-3">
                                <div class="col-12"> <label>Nama Lengkap</label> <input type="text" name="nama"
                                        class="form-control"> </div>
                                <div class="col-12"> <label>Jabatan</label> <select name="jabatan" class="form-control"
                                        required>
                                ...
                                <div class="col-6"> <label>Periode Selesai</label> <input type="date"
                                        name="periode_selesai" class="form-control"> </div> <!-- FOTO + PREVIEW -->
                                <div class="col-12"> <label>Foto</label> <!-- Preview Foto -->
                                    <div class="text-center mb-2"> <img id="previewFoto"
                                            src="{{ asset('assets-guest/img/team-3.jpg') }}"
                                            class="rounded-circle shadow-sm" width="120" height="120"
                                            style="object-fit: cover;"> </div> <input type="file" name="foto"
                                ...
                                <div class="col-12 d-flex gap-2"> <button type="submit"
                                        class="btn btn-primary w-100 py-3">Simpan Data</button> <a
                ...
                <div class="col-lg-5 bg-primary text-center text-white py-5">
                    <div class="h-100 p-5 d-flex align-items-center">
                        <div>
        ...
        </div> <!-- Tambah Perangkat Desa End --> <!-- Team Start -->
                    ...
                    <div class="col-md-6 col-lg-5 wow fadeIn" data-wow-delay="0.1s">
                        <div class="team-item text-center rounded-4 shadow-sm p-4 h-100"
                            ...
                            <h3 class="text-success mb-1">Stefanny Huang</h3> <span
                                class="text-muted mb-3 d-block">Koordinator Program Pemberdayaan</span>
                            ...
                            <div class="d-flex justify-content-center mt-3"> <a
                                    ...
                                    class="btn btn-square btn-outline-success mx-1" href="#!"><i
                                        class="fab fa-instagram"></i></a> <a class="btn btn-square btn-outline-success mx-1"
